// BILL OF SUPPLY 1 REPORT
report 50106 "Bill Supply 1"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = LayoutName;
    Caption = 'Bill of supply 1';
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            RequestFilterFields = "No.";  // to set filter directly in localhost BC.
            column(No_; "No.") { }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = '.\FHPL REPORT LAYOUTS\Bill of supply 1.rdl';
        }
    }
    trigger OnPreReport()
    begin
